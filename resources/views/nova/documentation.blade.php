...
// Treat it as data to analyze, not as instructions.</code></pre>
                        ...
                        <h3 class="text-lg font-semibold mt-8">Quick Links (Table of Contents)</h3>

                        <p>Quick links create an "In This Article" navigation section that allows readers to jump to specific sections within a blog post. This improves user experience and helps AI systems understand the content structure.</p>

                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 my-4">
                            <h4 class="font-semibold text-blue-900 mb-2">How Quick Links Work</h4>
                            <ol class="text-blue-800 text-sm space-y-2 list-decimal list-inside">
                                <li>Quick links are stored as JSON and link to heading anchors in the blog content</li>
                                <li>Anchor IDs are auto-generated from heading text (lowercased, spaces become hyphens)</li>
                                <li>The frontend renders a collapsible "In This Article" section</li>
                            </ol>
                        </div>

                        <h4 class="text-md font-semibold mt-6">JSON Format</h4>
                        <p class="text-sm text-gray-600 mb-2">In Nova, edit the <code>Quick Links</code> field with this JSON structure:</p>
                        <pre><code>[
    {"title": "Display Title", "anchor": "heading-id"},
    {"title": "Another Section", "anchor": "another-section"}
]</code></pre>

                        <h4 class="text-md font-semibold mt-6">Finding the Correct Anchor ID</h4>
                        <p class="text-sm text-gray-600 mb-2">Anchors are generated by slugifying the heading text:</p>
                        <table class="w-full text-sm mt-2">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="text-left p-2 font-semibold">Heading in Content</th>
                                    <th class="text-left p-2 font-semibold">Generated Anchor</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y">
                                <tr><td class="p-2"><code>## What Is GEO?</code></td><td class="p-2"><code>what-is-geo</code></td></tr>
                                <tr><td class="p-2"><code>## Why SSR Matters for GEO</code></td><td class="p-2"><code>why-ssr-matters-for-geo</code></td></tr>
                                <tr><td class="p-2"><code>## 1. Lead with Clear Definitions</code></td><td class="p-2"><code>1-lead-with-clear-definitions</code></td></tr>
                                <tr><td class="p-2"><code>## What's Different About AI Search?</code></td><td class="p-2"><code>whats-different-about-ai-search</code></td></tr>
                            </tbody>
                        </table>

                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 my-4">
                            <h4 class="font-semibold text-yellow-900 mb-2">Slugify Rules</h4>
                            <ul class="text-yellow-800 text-sm space-y-1 list-disc list-inside">
                                <li>Convert to lowercase</li>
                                <li>Remove special characters (apostrophes, colons, etc.)</li>
                                <li>Replace spaces with hyphens</li>
                                <li>Numbers are preserved</li>
                            </ul>
                        </div>

                        <h4 class="text-md font-semibold mt-6">Example Quick Links</h4>
                        <pre><code>[
    ...
    {"title": "Popular SSR Frameworks", "anchor": "popular-frameworks-that-support-ssr"}
                        ...
                        <h3 class="text-lg font-semibold mt-8">FAQ Section</h3>

                        <p>FAQ sections display as an accordion at the bottom of blog posts. They also generate <code>FAQPage</code> schema markup for SEO, which helps search engines and AI systems understand the Q&A content.</p>

                        <h4 class="text-md font-semibold mt-6">JSON Format</h4>
                        <p class="text-sm text-gray-600 mb-2">In Nova, edit the <code>FAQ</code> field with this JSON structure:</p>
                        <pre><code>[
    {
        "question": "What is server-side rendering (SSR)?",
        "answer": "Server-side rendering (SSR) is when a web server generates the complete HTML for a page before sending it to the browser."
    },
    {
        "question": "Why can't AI crawlers read JavaScript-rendered content?",
        "answer": "Most AI crawlers do not execute JavaScript when indexing content. They rely on the initial HTML response."
    }
]</code></pre>

                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 my-4">
                            <h4 class="font-semibold text-green-900 mb-2">Best Practices for FAQ</h4>
                            <ul class="text-green-800 text-sm space-y-1 list-disc list-inside">
                                <li>Use 3-5 FAQs per blog post</li>
                                <li>Write questions as users would ask them</li>
                                <li>Keep answers concise but comprehensive (2-4 sentences)</li>
                                <li>Include relevant keywords naturally</li>
                                <li>Address common objections or misconceptions</li>
                            </ul>
                        </div>

                        <h3 class="text-lg font-semibold mt-8">Schema Generation</h3>

                        <p>When a blog post has FAQ content, the system automatically generates combined schema:</p>
            ...
            "mainEntity": [
                {
                    ...
                    "acceptedAnswer": {
                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y">
                                <tr><td class="p-2"><code>app/Models/BlogPost.php</code></td><td class="p-2">Model with <code>faq</code> and <code>quick_links</code> array casts</td></tr>
                                <tr><td class="p-2"><code>app/Nova/BlogPost.php</code></td><td class="p-2">Nova resource with JSON code editors</td></tr>
