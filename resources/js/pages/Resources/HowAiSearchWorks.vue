        ...
        <main id="main-content" role="main">
                        ...
                        <Card class="border-amber-500/50 bg-amber-500/5">
                            <CardContent class="pt-6">
                                <div class="flex items-start gap-3">
                                    <XCircle class="h-6 w-6 text-amber-500 shrink-0 mt-0.5" aria-hidden="true" />
                                    <div>
                    ...
                    <section class="mb-12" aria-labelledby="ai-components">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <Card v-for="component in aiComponents" :key="component.title">
                                <CardContent class="pt-6">
                                    <div class="flex items-start gap-3">
                                        <component :is="component.icon" class="h-6 w-6 text-primary shrink-0" aria-hidden="true" />
                                        <div>
            ...
            <section aria-labelledby="cta-heading" class="border-t bg-muted/30 py-12">
                <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                    <h2 id="cta-heading" class="text-2xl font-bold">Optimize your content for AI systems</h2>
