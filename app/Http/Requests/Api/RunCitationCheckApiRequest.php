...
/**
 * Validates API requests to run a citation check.
 */
class RunCitationCheckApiRequest extends FormRequest
{
        ...
        return [
            function (Validator $validator) {
                ...
                if (! in_array($platform, $availablePlatforms)) {
                    $validator->errors()->add('platform', 'This platform is not available.');
